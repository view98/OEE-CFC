...
def get_args_parser():
    ...
    parser.add_argument("--model_name_or_path", default="./ckpts/bart-base-chinese", type=str,
                        help="pre-trained language model")
    parser.add_argument("--dataset_type", default="OEE_CFC", choices=["ace_eeqa", "rams","OEE_CFC", "wikievent"], type=str,
                        help="dataset type. Both sentence-level(ace_eeqa) and document-level(rams/wikievent)")
    parser.add_argument("--role_path", default='./data/dset_meta/description_OEE_CFC.csv', type=str,
                        help="a file containing all role names. Read it to access all argument roles of this dataset")
    parser.add_argument("--prompt_path", default='./data/prompts/prompts_OEE_CFC_specific_continuous.csv', type=str,
    ...
    parser.add_argument("--max_enc_seq_length", default=600, type=int,
    ...
    parser.add_argument("--max_prompt_seq_length", default=300, type=int,
