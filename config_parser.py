...
def get_args_parser():
    ...
    parser.add_argument("--dataset_type", default="OEE_CFC", choices=["OEE_CFC","ace_eeqa", "rams", "wikievent"], type=str,
    ...
    parser.add_argument("--max_dec_seq_length", default=512, type=int,
    ...
    parser.add_argument("--max_prompt_seq_length", default=200, type=int,
